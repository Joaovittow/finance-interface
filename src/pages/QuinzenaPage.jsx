...
import { Plus, Check, DollarSign, TrendingUp, TrendingDown, Edit, Trash2 } from 'lucide-react'
...
const QuinzenaPage = () => {
  ...
  const handleAdicionarReceita = async (e) => {
    ...
    try {
      ...
      setNovaReceita({ descricao: '', valor: '', tipo: TIPOS_RECEITA.VARIAVEL })
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">
            {quinzenaAtual.tipo === 'primeira' ? 'Quinzena do Dia 15' : 'Quinzena do Dia 30'}
          </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card padding="small">
          ...
          <p className={`text-xl font-bold mt-1 ${quinzenaAtual.saldoAnterior >= 0 ? 'text-green-600' : 'text-red-600'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            {editandoReceita && (
              <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <h3 className="font-medium text-gray-800 mb-3">Editando Receita</h3>
                <ReceitaForm
            ...
            <div className="space-y-3">
              ...
              {(!quinzenaAtual.receitas || quinzenaAtual.receitas.length === 0) && (
        ...
        <div className="space-y-6">
          <Card>
            ...
            {editandoDespesa && (
              <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <h3 className="font-medium text-gray-800 mb-3">Editando Despesa</h3>
                <DespesaForm
            ...
            <div className="space-y-3">
                        ...
                        <div className="flex items-center space-x-2 ml-4">
                          {parcela.despesa && !editandoDespesa && (
                            <>
                              <button 
                                className="p-2 text-gray-400 hover:text-gray-600 transition-colors"
                                onClick={() => setEditandoDespesa(parcela.despesa)}
                              ...
                              <button 
                                className="p-2 text-gray-400 hover:text-red-600 transition-colors"
                                onClick={() => handleExcluirDespesa(parcela.despesa)}
              ...
              {(!quinzenaAtual.parcelas || quinzenaAtual.parcelas.length === 0) && (
                <div className="text-center py-6 text-gray-500">
